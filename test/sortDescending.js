...
async function example() {
  let driver = await new Builder().forBrowser('chrome').build();
    ...
    // LOCATE THE OPTION
    await driver.findElement(By.xpath('//*[@id="content-listings"]/div[1]/div[2]/select/option[2]')).click();
    // AFTER SORT
    ...
    const expectedValue = ['$7,900,000','$5,495,000','$1,500,000','$1,350,000','$950,000','$415,000']

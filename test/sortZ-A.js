...
async function example() {
  let driver = await new Builder().forBrowser('chrome').build();
    ...
    // SELECT OPTION
    await driver.findElement(By.xpath('//*[@id="content-listings"]/div[1]/div[2]/select/option[6]')).click();
    ...
    const expectedValue = texts2.sort(function(a, b){return a.length + b.length});
